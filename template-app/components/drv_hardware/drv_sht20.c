...
float Sht20_GetTemper()
{
    ...
    I2C_WriteData(I2C_NUM_0, SHT20_ADDRESS, SHT20_T_NO_HOLD, 0, 0); //地址+指令
    vTaskDelay(40 / portTICK_PERIOD_MS);
    I2C_ReadData(I2C_NUM_0, SHT20_ADDRESS, 0, 0, 0);
    vTaskDelay(40 / portTICK_PERIOD_MS);
    I2C_ReadData(I2C_NUM_0, SHT20_ADDRESS, 0, temperature, 3);
...
float Sht20_GetHumidity()
{
    ...
    I2C_WriteData(I2C_NUM_0, SHT20_ADDRESS, SHT20_RH_NO_HOLD, 0, 0); //地址+指令
    vTaskDelay(20 / portTICK_PERIOD_MS);
    I2C_ReadData(I2C_NUM_0, SHT20_ADDRESS, 0, 0, 0);
    vTaskDelay(20 / portTICK_PERIOD_MS);
    I2C_ReadData(I2C_NUM_0, SHT20_ADDRESS, 0, humidity, 3);
